...
class DoorPullEnv(DoorOpenEnv):
    def __init__(self,resolution=(64,64),cam_noise=0.0, door_width=0.9):
        super(DoorPullEnv, self).__init__(resolution, cam_noise, door_width)
    ...
    def _take_action(self, action_idx):
      ...
      print(action_idx, action, self.delta, self.success, self.fail)
    ...
    def _random_init_mobile_robot(self):
        ...
        cy = 0.01*(radref[1]-0.5)+self.door_dim[0]+0.045

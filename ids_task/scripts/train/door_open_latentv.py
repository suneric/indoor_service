...
def lfppo_train(env,z_dim,num_episodes,train_freq,max_steps,warmup,model_dir):
...
if __name__=="__main__":
    ...
    ep_returns = lfppo_train(env,args.z_dim,args.max_ep,args.train_freq,args.max_step,args.warmup,model_dir)
    env.close()

...
class FrameDeviceController:
    ...
    def move_vslider_to(self,vs=0.0,tol=1e-4):
    ...
    def move_hslider_to(self,hs=0.0,tol=1e-4):
    ...
    def move_hook_to(self,hp=0.0,tol=1e-4):
        if self.hook.locked:
            return
        rate = rospy.Rate(30)
    ...
    def move_plug_to(self,pg=0.0,tol=1e-4):
        if self.plug.locked:
            return
        rate = rospy.Rate(30)
